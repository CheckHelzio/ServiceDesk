package checkhelzio.ccv.servicedeskcucsh.HTextView;
...
public abstract class HText implements IHText {
    ...
    public void setTextoInicial(CharSequence textInicial){
        mHTextView.setText(textInicial);
        mOldText = textInicial;
        mText = textInicial;
        prepareAnimate();
        animatePrepare(textInicial);
        animateStart(textInicial);
    }
